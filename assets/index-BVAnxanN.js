...
const Hp = () =>
	...
	th = '/assets/work009-BbqNS4-n.png',
	nh = '/assets/work010-v3WaCUgf.png',
	xa = [
		{
			id: 10,
			image: nh,
		...
		return c.jsxs('div', {
			children: [
				...
				c.jsx('div', {
					...
					children: n.map((a) => c.jsx(ih, { item: a }, a.id))
				})
			]
		});
	},
		...
		c.jsxs('section', {
			...
			children: [
				...
				c.jsxs('div', {
					...
					children: [c.jsx(uh, {}), c.jsx(ch, {}), c.jsx(dh, {})]
				})
			]
		});
function Sa(e) {
...
class mt extends Array {
	constructor(t) {
		typeof t == 'number' ? super(t) : (super(...(t || [])), hh(this));
	}
}
function wr(e = []) {
	const t = [];
...
function am({ swiper: e, on: t, emit: n }) {
	const r = le();
	let i = null,
		l = null;
	const s = () => {
...
function um({ swiper: e, extendParams: t, on: n, emit: r }) {
	const i = [],
		l = le(),
		s = (u, d = {}) => {
...
function mm(e = (this && this.translate) || 0) {
	const t = this,
		n = t.params,
...
const xm = {
	...
	updateSlides: fm,
	updateAutoHeight: pm,
	updateSlidesOffset: hm,
	updateSlidesProgress: mm,
	updateProgress: vm,
	updateSlidesClasses: gm,
	updateActiveIndex: ym,
	updateClickedSlide: wm
};
function Sm(e = this.isHorizontal() ? 'x' : 'y') {
	const t = this,
...
const Pm = { setTransition: Tm, transitionStart: jm, transitionEnd: Lm };
function Mm(e = 0, t = this.params.speed, n = !0, r, i) {
...
function Dm(e = this.params.speed, t = !0, n) {
	const r = this;
	return r.slideTo(r.activeIndex, e, t, n);
}
function Rm(e = this.params.speed, t = !0, n, r = 0.5) {
	const i = this;
	let l = i.activeIndex;
...
const Hm = { loopCreate: Fm, loopFix: Bm, loopDestroy: Vm };
function Wm(e) {
	const t = this;
	if (
		t.support.touch ||
...
const Gm = { setGrabCursor: Wm, unsetGrabCursor: Um };
...
function Qm(e) {
	...
	if (l.noSwiping && (g ? qm(f, u[0]) : u.closest(f)[0])) {
		t.allowClick = !0;
		return;
	}
...
function bm() {
	...
	(e.onTouchStart = Qm.bind(e)),
		...
		(e.onClick = Km.bind(e)),
		r.touch && !Ca && (t.addEventListener('touchstart', Jm), (Ca = !0)),
		qc(e, 'on');
}
function e0() {
	qc(this, 'off');
}
const t0 = { attachEvents: bm, detachEvents: e0 },
...
const i0 = { setBreakpoint: n0, getBreakpoint: r0 };
function l0(e, t) {
	const n = [];
	return (
		e.forEach((r) => {
...
const a0 = { addClasses: s0, removeClasses: o0 };
function u0(e, t, n, r, i, l) {
	const s = le();
	let a;
	function o() {
		l && l();
...
const d0 = { loadImage: u0, preloadImages: c0 };
function f0() {
	const e = this,
...
let Cn = class Ke {
	constructor(...t) {
		...
		(i.__swiper__ = !0),
			(i.support = Uc()),
			(i.device = lm({ userAgent: r.userAgent })),
			(i.browser = om()),
			(i.eventsListeners = {}),
...
const k0 = $.createContext(null),
	C0 = $.createContext(null);
function fs() {
	return (
		(fs = Object.assign
			? Object.assign.bind()
...
const E0 = $.forwardRef(function (e, t) {
	let {
			className: n,
			tag: r = 'div',
			wrapperTag: i = 'div',
	...
	const [u, d] = $.useState('swiper'),
		...
		N = $.useRef(null),
		L = $.useRef(null),
		{ params: k, passedParams: F, rest: E, events: z } = m0(a),
		{ slides: I, slots: ne } = w0(l),
		Xe = () => {
			w(!g);
		};
	Object.assign(k.on, {
	...
	$.useEffect(() => () => {
		...
		Xn(() => {
			zt();
			const M = y0(F, h.current, I, v.current, (O) => O.key);
			return (
				(h.current = F),
				(v.current = I),
				M.length &&
...
const N0 = $.forwardRef(function (e, t) {
	let {
		tag: n = 'div',
		children: r,
		className: i = '',
...
gl.createRoot(document.getElementById('root')).render(
	c.jsx(B.StrictMode, { children: c.jsx(T0, {}) })
);
