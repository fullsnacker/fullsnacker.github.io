...
function Aa(e, t, n) {
	...
	for (r in t) _d.call(t, r) && !Cd.hasOwnProperty(r) && (i[r] = t[r]);
	if (e && e.defaultProps)
 ...
 */ (function (e) {
	...
	function r(j) {
		...
		if (O !== M) {
			j[0] = O;
			e: for (var G = 0, Z = j.length, xr = Z >>> 1; G < xr; ) {
				var It = 2 * (G + 1) - 1,
					Fi = j[It],
					Dt = It + 1,
					Sr = j[Dt];
				if (0 > i(Fi, O))
					Dt < Z && 0 > i(Sr, Fi)
						? ((j[G] = Sr), (j[Dt] = O), (G = Dt))
						: ((j[G] = Fi), (j[It] = O), (G = It));
				else if (Dt < Z && 0 > i(Sr, O)) (j[G] = Sr), (j[Dt] = O), (G = Dt);
				else break e;
			}
		}
		return M;
	...
	function i(j, M) {
		var O = j.sortIndex - M.sortIndex;
		return O !== 0 ? O : j.id - M.id;
	}
	...
	(e.unstable_IdlePriority = 5),
		...
		(e.unstable_scheduleCallback = function (j, M, O) {
			...
			return (
				...
				O > G
					...
					: ((j.sortIndex = Z), t(o, j), w || g || ((w = !0), zt(S))),
				j
			);
		}),
...
function xo(e) {
	if ((e = gr(e))) {
		...
		var t = e.stateNode;
		t && ((t = Ti(t)), Ml(e.stateNode, e.type, t));
	}
}
function Ja(e) {
...
function Ts(e, t, n, r) {
	if (ii) {
		...
		else if ((ko(e, r), t & 4 && -1 < Zd.indexOf(e))) {
			for (; i !== null; ) {
				var l = gr(i);
				if (
					(l !== null && fu(l),
...
var li = null;
function Al(e, t, n, r) {
	if (((li = null), (e = Cs(r)), (e = $t(e)), e !== null))
...
var Nn = {
	...
	Yi = Te(sf),
	of = Y({}, Nn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
	af = Te(of),
	uf = Y({}, Nn, {
...
var vf = Y({}, vr, {
	...
	xf = Te(wf),
	Sf = Y({}, Nn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
	_f = Te(Sf),
	kf = Y({}, Ei, {
		deltaX: function (e) {
...
var Nf = nt && 'TextEvent' in window && !Hn,
...
function ji(e) {
	...
	var t = nn[e],
		n;
	for (n in t) if (t.hasOwnProperty(n) && n in ju) return (Zi[e] = t[n]);
	return e;
}
var Tu = ji('animationend'),
	Lu = ji('animationiteration'),
	Pu = ji('animationstart'),
	Mu = ji('transitionend'),
	zu = new Map(),
	Ro =
...
Tt(Tu, 'onAnimationEnd');
Tt(Lu, 'onAnimationIteration');
Tt(Pu, 'onAnimationStart');
Tt('dblclick', 'onDoubleClick');
Tt('focusin', 'onFocus');
Tt('focusout', 'onBlur');
Tt(Mu, 'onTransitionEnd');
...
var jn = Math.random().toString(36).slice(2),
	...
	Wl = '__reactEvents$' + jn,
	Qf = '__reactListeners$' + jn,
	Yf = '__reactHandles$' + jn;
function $t(e) {
	var t = e[Ge];
	if (t) return t;
...
function Wo(e, t, n) {
	if (fe.current !== jt) throw Error(_(168));
	V(fe, t), V(we, n);
}
function Du(e, t, n) {
	var r = e.stateNode;
...
function Pt() {
	if (!rl && be !== null) {
		...
		try {
			...
			throw (be !== null && (be = be.slice(e + 1)), ou(Es, Pt), i);
		} finally {
			($ = t), (rl = !1);
		}
	}
...
function Or(e) {
	...
	if (
		...
		for (; t; ) $u(e, t), (t = xt(t.nextSibling));
	}
	if ((qo(e), e.tag === 13)) {
...
function Uu(e) {
	...
	function f(p, h, v, y) {
		...
		if (typeof v == 'object' && v !== null) {
			...
			if (Rn(v) || Tn(v)) return S !== null ? null : d(p, h, v, y, null);
			Ir(p, v);
		}
		return null;
	}
	function g(p, h, v, y, S) {
		...
		if (typeof y == 'object' && y !== null) {
			...
			if (Rn(y) || Tn(y)) return (p = p.get(v) || null), d(h, p, y, S, null);
			Ir(h, y);
		}
		return null;
	}
	function w(p, h, v, y) {
		...
		if (k === v.length) return n(p, L), U && At(p, k), S;
		if (L === null) {
			for (; k < v.length; k++)
				(L = m(p, v[k], y)),
					L !== null &&
	...
	function x(p, h, v, y) {
		...
		if (E.done) return n(p, L), U && At(p, k), S;
		if (L === null) {
...
function sa(e, t, n, r, i) {
	return wn(), As(i), (t.flags |= 256), pe(e, t, n, r), t.child;
}
...
function dp(e, t) {
	...
	for (Bl = { focusedElem: e, selectionRange: n }, ii = !1, T = t; T !== null; )
	...
	switch (e.tag) {
		...
		case 22:
			if (
				...
				e.mode & 1 ? ((de = (u = de) || d), Ae(t, e), (de = u)) : Ae(t, e),
				We(e),
				r & 8192)
			) {
				if (
						...
						(s = T),
							...
							s.tag === 22 && s.memoizedState !== null
								...
								: o !== null
									? ((o.return = s), (T = o))
									: pa(i);
				for (; l !== null; ) (T = l), jc(l), (l = l.sibling);
				(T = i), (Ar = a), (de = u);
			}
			da(e);
		} else
			i.subtreeFlags & 8772 && l !== null ? ((l.return = i), (T = l)) : da(e);
	}
}
function da(e) {
	for (; T !== null; ) {
	...
	if (t !== 0) {
		...
		if (t === 6) ft(e, r);
			...
			switch (((e.finishedWork = i), (e.finishedLanes = r), t)) {
				...
				case 3:
					if (
						(ft(e, r), (r & 130023424) === r && ((t = Js + 500 - K()), 10 < t))
					) {
						if (ri(e, 0) !== 0) break;
						...
						e.timeoutHandle = Hl(Rt.bind(null, e, ge, Ze), t);
						break;
					}
					Rt(e, ge, Ze);
					break;
				case 4:
					...
					if (
						...
						e.timeoutHandle = Hl(Rt.bind(null, e, ge, Ze), r);
						break;
					}
					Rt(e, ge, Ze);
					break;
...
function vn() {
	if (ht !== null) {
		var e = du(xi),
			...
			n = $;
		try {
			if (((Oe.transition = null), ($ = 16 > e ? 16 : e), ht === null))
				var r = !1;
			else {
				if (((e = ht), (ht = null), (xi = 0), R & 6)) throw Error(_(331));
				var i = R;
				for (R |= 4, T = e.current; T !== null; ) {
					var l = T,
						s = l.child;
					if (T.flags & 16) {
						var a = l.deletions;
...
function yp(e, t, n) {
	...
	r !== null && r.delete(t),
		...
		ie === e &&
			(oe & n) === n &&
			(te === 4 || (te === 3 && (oe & 130023424) === oe && 500 > K() - Js)
				? Vt(e, 0)
				: (bs |= n)),
		Se(e, t);
}
...
tu = eo;
nu = Qt;
var jp = { usingClientEntryPoint: !1, Events: [gr, rn, Ti, Ja, eu, eo] },
	Dn = {
...
function Hc(e) {
	return (
		e &&
		e.map(function (t, n) {
			return B.createElement(t.tag, Et({ key: n }, t.attr), Hc(t.child));
		})
	);
}
function Ye(e) {
	return function (t) {
		return B.createElement(Op, Et({ attr: Et({}, e.attr) }, t), Hc(e.child));
	};
}
function Op(e) {
	var t = function (n) {
...
const Hp = () =>
	...
	th = '/assets/work008-4QwL473f.png',
	xa = [
		{
			id: 1,
			image: Yp,
		...
		return c.jsxs('div', {
			children: [
				...
				c.jsx('div', {
					...
					children: n.map((a) => c.jsx(rh, { item: a }, a.id))
				})
			]
		});
	},
		...
		c.jsxs('section', {
			...
			children: [
				...
				c.jsxs('div', {
					...
					children: [c.jsx(ah, {}), c.jsx(uh, {}), c.jsx(ch, {})]
				})
			]
		});
function Sa(e) {
...
class mt extends Array {
	constructor(t) {
		typeof t == 'number' ? super(t) : (super(...(t || [])), ph(this));
	}
}
function wr(e = []) {
	const t = [];
...
function om({ swiper: e, on: t, emit: n }) {
	const r = le();
	let i = null,
		l = null;
	const s = () => {
...
function am({ swiper: e, extendParams: t, on: n, emit: r }) {
	const i = [],
		l = le(),
		s = (u, d = {}) => {
...
function hm(e = (this && this.translate) || 0) {
	const t = this,
		n = t.params,
...
const wm = {
	...
	updateSlidesProgress: hm,
	updateProgress: mm,
	updateSlidesClasses: vm,
	updateActiveIndex: gm,
	updateClickedSlide: ym
};
function xm(e = this.isHorizontal() ? 'x' : 'y') {
	const t = this,
...
const Lm = { setTransition: Nm, transitionStart: jm, transitionEnd: Tm };
function Pm(e = 0, t = this.params.speed, n = !0, r, i) {
...
function Mm(e = 0, t = this.params.speed, n = !0, r) {
	if (typeof e == 'string') {
...
function Im(e = this.params.speed, t = !0, n) {
	const r = this;
	return r.slideTo(r.activeIndex, e, t, n);
}
function Dm(e = this.params.speed, t = !0, n, r = 0.5) {
	const i = this;
	let l = i.activeIndex;
...
const Vm = { loopCreate: $m, loopFix: Fm, loopDestroy: Bm };
function Hm(e) {
	const t = this;
	if (
		t.support.touch ||
...
const Um = { setGrabCursor: Hm, unsetGrabCursor: Wm };
function Gm(e, t = this) {
	function n(r) {
...
function qm(e) {
	...
	if (l.noSwiping && (g ? Gm(f, u[0]) : u.closest(f)[0])) {
		t.allowClick = !0;
		return;
	}
...
function bm() {
	...
	(e.onTouchStart = qm.bind(e)),
		...
		(e.onTouchEnd = Ym.bind(e)),
		n.cssMode && (e.onScroll = Km.bind(e)),
		(e.onClick = Xm.bind(e)),
		r.touch && !Ca && (t.addEventListener('touchstart', Zm), (Ca = !0)),
		Yc(e, 'on');
}
function Jm() {
	Yc(this, 'off');
}
const e0 = { attachEvents: bm, detachEvents: Jm },
...
const r0 = { setBreakpoint: t0, getBreakpoint: n0 };
function i0(e, t) {
	const n = [];
	return (
		e.forEach((r) => {
...
const o0 = { addClasses: l0, removeClasses: s0 };
function a0(e, t, n, r, i, l) {
	const s = le();
	let a;
	function o() {
		l && l();
...
const c0 = { loadImage: a0, preloadImages: u0 };
function d0() {
	const e = this,
...
let Cn = class Ke {
	constructor(...t) {
		...
		(i.__swiper__ = !0),
			(i.support = qc()),
			(i.device = im({ userAgent: r.userAgent })),
			(i.browser = sm()),
			(i.eventsListeners = {}),
...
const _0 = D.createContext(null),
	k0 = D.createContext(null);
function fs() {
	return (
		(fs = Object.assign
			? Object.assign.bind()
...
const C0 = D.forwardRef(function (e, t) {
	...
	const [u, d] = D.useState('swiper'),
		...
		N = D.useRef(null),
		L = D.useRef(null),
		{ params: k, passedParams: F, rest: E, events: z } = h0(a),
		{ slides: I, slots: ne } = y0(l),
		Xe = () => {
			w(!g);
		};
	Object.assign(k.on, {
	...
	const Mt = () => {
		if (
			...
			k.loop && (p.current.loopedSlides = ed(I, k)),
	...
	D.useEffect(() => () => {
		...
		Xn(() => {
			zt();
			const M = g0(F, h.current, I, v.current, (O) => O.key);
			return (
				(h.current = F),
				(v.current = I),
				M.length &&
...
const E0 = D.forwardRef(function (e, t) {
	let {
		tag: n = 'div',
		children: r,
		className: i = '',
...
E0.displayName = 'SwiperSlide';
const N0 = 'B5bzISzoDHudUfdQ5WxDhodGQL4DjYEzurVCpVo8',
	j0 = ({ examples: e, answers: t, initialMessage: n }) => {
	...
	T0 = {
		...
		info: c.jsx('p', {
			children:
				'Soy Juan Manuel Garcia (A.K.A Fullsnacker), soy desarrollador FullStack. Trabajo con el stack MERN hace 10 años.'
		}),
		contact: c.jsxs('p', {
			children: [
...
gl.createRoot(document.getElementById('root')).render(
	c.jsx(B.StrictMode, { children: c.jsx(P0, {}) })
);
